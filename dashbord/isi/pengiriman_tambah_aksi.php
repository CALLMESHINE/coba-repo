...
$id_bumdes_asal = isset($_SESSION['id_bumdes']) ? $_SESSION['id_bumdes'] : null;

if ($id_petugas === null || $id_bumdes_asal === null) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $no_hp_pengirim = isset($_POST['no_hp_pengirim']) ? $_POST['no_hp_pengirim'] : null;
    $alamat_asal = isset($_POST['alamat_asal']) ? mysqli_real_escape_string($koneksi, $_POST['alamat_asal']) : null;
    ...
    if ($nama_pengirim !== null && $no_hp_pengirim !== null && $alamat_asal !== null && $id_bumdes_asal !== null && $id_bumdes_tujuan !== null && $alamat_tujuan !== null && $nm_penerima !== null && $no_hp_penerima !== null && $status_kirim !== null && $status_bayar !== null && $waktu_status_kirim_packing !== null && $waktu_status_kirim_penyortiran !== null && $waktu_status_kirim_pengiriman !== null && $waktu_status_barang_sampai !== null && $id_kurir !== null && $total_bayar !== null && $id_kecamatan !== null) {
        
        $alamat_asal = mysqli_real_escape_string($koneksi, $alamat_asal);
        $query = "INSERT INTO pengiriman (id_petugas, nama_pengirim, no_hp_pengirim, alamat_asal, id_bumdes_asal, id_bumdes_tujuan, alamat_tujuan, nm_penerima, no_hp_penerima, status_kirim, status_bayar, id_kurir, total_bayar, waktu_status_kirim_packing, waktu_status_kirim_penyortiran, waktu_status_kirim_pengiriman, waktu_status_barang_sampai, id_kecamatan) 
                    VALUES ('$id_petugas', '$nama_pengirim', '$no_hp_pengirim', '$alamat_asal', '$id_bumdes_asal', '$id_bumdes_tujuan', '$alamat_tujuan', '$nm_penerima', '$no_hp_penerima', '$status_kirim', '$status_bayar', '$id_kurir', '$total_bayar', '$waktu_status_kirim_packing', '$waktu_status_kirim_penyortiran', '$waktu_status_kirim_pengiriman', '$waktu_status_barang_sampai', '$id_kecamatan')";
    ...
    // else
    //  {
    //              echo "id_petugas: " . $id_petugas . "<br>";
    //              echo "nama_pengirim: " . $nama_pengirim . "<br>";
    //              echo "no_hp_pengirim: " . $no_hp_pengirim . "<br>";
    //              echo "alamat_asal: " . $alamat_asal . "<br>";
    //              echo "id_bumdes_asal: " . $id_bumdes_asal . "<br>";
    //              echo "id_bumdes_tujuan: " . $id_bumdes_tujuan . "<br>";
    //              echo "id_kecamatan: " . $id_kecamatan . "<br>";
    //              echo "alamat_tujuan: " . $alamat_tujuan . "<br>";
    //              echo "nm_penerima: " . $nm_penerima . "<br>";
    //              echo "no_hp_penerima: " . $no_hp_penerima . "<br>";
    //              echo "status_kirim: " . $status_kirim . "<br>";
    //              echo "status_bayar: " . $status_bayar . "<br>";
    //              echo "waktu_status_kirim_packing: " . $waktu_status_kirim_packing . "<br>";
    //              echo "waktu_status_kirim_penyortiran: " . $waktu_status_kirim_penyortiran . "<br>";
    //              echo "waktu_status_kirim_pengiriman: " . $waktu_status_kirim_pengiriman . "<br>";
    //                 echo "waktu_status_barang_sampai: " . $waktu_status_barang_sampai . "<br>";
    //              echo "id_kurir: " . $id_kurir . "<br>";
    //              echo "total_bayar: " . $total_bayar . "<br>";
            
    //             // echo "Error: " . mysqli_error($koneksi); // Tambahkan baris ini
    //         }
