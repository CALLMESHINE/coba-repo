...
// Jika form di-post, jalankan blok ini untuk memproses data pengiriman yang diubah
...
// If id_petugas is not set, redirect to login page or display an error message
if ($id_petugas === null) {
