            ...
            <div class="col-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">EDIT DATA ADMIN BUMDES</h3>
                </div>
                <?php
                include("../../koneksi.php");
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM admin_bumdes WHERE id_petugas = '$id'");
                ...
                <form method="post" action="edit_admin_bumdes_aksi.php">
                  <div class="card-body">
                    ...
                    <div>
                        ...
                        <textarea name="alamat_asal"><?php echo $d['alamat_asal']; ?></textarea>
                      </div>
                    <div class="form-group">
