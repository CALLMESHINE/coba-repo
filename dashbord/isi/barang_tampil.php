            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <a href="barang_tambah.php"><button type="submit" class="btn btn-primary">TAMBAH</button></a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
				...
				<td><?php echo $d['biaya']; ?></td>
                          <td>
                            <a href="barang_edit.php?id=<?php echo $d['id_barang']; ?>"><button type="submit"
                                class="btn btn-warning">EDIT</button></a>
                            <a href="barang_hapus.php?id=<?php echo $d['id_barang']; ?>"><button type="submit"
