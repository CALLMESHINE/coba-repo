            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <a href="pengiriman_tambah.php"><button type="submit" class="btn btn-primary">TAMBAH</button></a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
WHERE p.id_bumdes_asal = '$id_bumdes'";
    ...
    <?php echo isset($d['alamat_asal']) ? $d['alamat_asal'] : ''; ?>
                            ...
                            <td>
                              <a
                                href="pengiriman_edit.php?id=<?php echo isset($d['id_pengiriman']) ? $d['id_pengiriman'] : ''; ?>"><button
                                  type="submit" class="btn btn-warning">EDIT</button></a>
                              <a
                                href="pengiriman_hapus.php?id=<?php echo isset($d['id_pengiriman']) ? $d['id_pengiriman'] : ''; ?>"><button
