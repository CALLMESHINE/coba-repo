          ...
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <?php
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM kecamatan WHERE id_kecamatan = '$id'");
              ...
              <form method="post" action="edit_kecamatan_aksi.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nm_kecamatan" class="form-control" value="<?php echo $d['nm_kecamatan']; ?>">
                  </div>
