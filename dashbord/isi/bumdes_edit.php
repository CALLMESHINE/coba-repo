            ...
            <div class="col-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">EDIT DATA BUMDES</h3>
                </div>
                <?php
                include("../../koneksi.php");
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM bumdes WHERE id_bumdes = '$id'");
                ...
                <form method="post" action="edit_bumdes_aksi.php">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nm_bumdes" class="form-control" value="<?php echo $d['nm_bumdes']; ?>">
                    </div>
